...
namespace GPUInstancer
{
    public class GPUInstancerHiZOcclusionGenerator : MonoBehaviour
    {
        ...
        private int _previousScreenSizeX;
        private int _previousScreenSizeY;
        ...
        public void Initialize(Camera occlusionCamera = null)
        {
...
#if UNITY_2017_2_OR_NEWER
#if GPUI_XR
                _previousScreenSizeX = UnityEngine.XR.XRSettings.eyeTextureWidth;
                _previousScreenSizeY = UnityEngine.XR.XRSettings.eyeTextureHeight;
#endif
#else
#if GPUI_VR
                _previousScreenSizeX = UnityEngine.VR.VRSettings.eyeTextureWidth;
                _previousScreenSizeY = UnityEngine.VR.VRSettings.eyeTextureHeight;
#endif
#endif
            ...
            {
                isVREnabled = false;
                _previousScreenSizeX = _mainCamera.pixelWidth;
                _previousScreenSizeY = _mainCamera.pixelHeight;
            }
...
#if UNITY_2017_2_OR_NEWER
#if GPUI_XR
                if (_previousScreenSizeX != UnityEngine.XR.XRSettings.eyeTextureWidth || _previousScreenSizeY != UnityEngine.XR.XRSettings.eyeTextureHeight)
                {
                    _previousScreenSizeX = UnityEngine.XR.XRSettings.eyeTextureWidth;
                    _previousScreenSizeY = UnityEngine.XR.XRSettings.eyeTextureHeight;
#endif
#else
#if GPUI_VR
                if (_previousScreenSizeX != UnityEngine.VR.VRSettings.eyeTextureWidth || _previousScreenSizeY != UnityEngine.VR.VRSettings.eyeTextureHeight)
                {
                    _previousScreenSizeX = UnityEngine.VR.VRSettings.eyeTextureWidth;
                    _previousScreenSizeY = UnityEngine.VR.VRSettings.eyeTextureHeight;
#endif
...
#endif
            {
                if (_previousScreenSizeX != _mainCamera.pixelWidth || _previousScreenSizeY != _mainCamera.pixelHeight)
                {
                    _previousScreenSizeX = _mainCamera.pixelWidth;
                    _previousScreenSizeY = _mainCamera.pixelHeight;
